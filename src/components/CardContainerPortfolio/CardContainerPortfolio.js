...
import "./CardContainerPortfolio.scss";
import jsonData from "../works.json";

const CardContainer = () => {
  const sixCardsData = jsonData.slice(0, 8);
  ...
  return (
    <div className="portfolio">
      ...
      <div className="row-deux">
        <div className="p-un">
          <Card
            key={sixCardsData[6].id}
            id={sixCardsData[6].id}
            title={sixCardsData[6].title}
            cover={sixCardsData[6].cover}
          />
        </div>
        <div className="p-deux">
          <Card
            key={sixCardsData[7].id}
            id={sixCardsData[7].id}
            title={sixCardsData[7].title}
            cover={sixCardsData[7].cover}
          />
        </div>
      </div>
    </div>
